report 50015 "Purchase Order Print"
{
    ...
    dataset
    {
        dataitem(PurchaseHeader; "Purchase Header")
        {
            ...
            column(TransactionTypeDesc; TransactionTypeDesc)
            {
            }
            column(SpecificationDesc; SpecificationDesc)
            {
            }
            ...
            begin
                ...
                TransactionTypeDesc := '';
                TransactionType1.SetRange(Code, PurchaseHeader."Transaction Type");
                if TransactionType1.FindFirst() then begin
                    TransactionTypeDesc := TransactionType1.Description;

                end;
                SpecificationDesc := '';
                TransactionSpecification.SetRange("Code", PurchaseHeader."Transaction Specification");
                if TransactionSpecification.FindFirst() then
                    SpecificationDesc := TransactionSpecification.Text;
    ...
    var
        ...
        TransactionType: Label 'Order Print';
        TransactionType1: Record "Transaction Type";
        transactionTypeDesc: Text[100];
        SpecificationDesc: Text[100];
