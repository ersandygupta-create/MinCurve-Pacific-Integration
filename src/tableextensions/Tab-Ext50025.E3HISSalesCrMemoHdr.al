tableextension 50025 "E3 HIS Sales Cr.Memo Hdr" extends "Sales Cr.Memo Header"
{
    fields
    {
        ...
        field(50108; "Indent Amount"; Decimal)
        {
            Caption = 'Indent Amount';
            DataClassification = ToBeClassified;
        }
        field(50109; "Station Name"; Text[60])
        {
            Caption = 'Station Name';
            DataClassification = ToBeClassified;
        }
        field(50110; "Order Amount"; Decimal)
        {
            DataClassification = ToBeClassified;
        }
        field(50111; "Integration PO Created"; Boolean)
        {
            DataClassification = ToBeClassified;
        }
        field(50112; "Indent Order"; Boolean)
        {
            DataClassification = ToBeClassified;
        }
    }
