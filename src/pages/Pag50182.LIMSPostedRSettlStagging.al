page 50182 "E3 Posted LIS Sett. Stagging"
{

    ApplicationArea = All;
    Caption = 'Posted LIS Settlement Stagging';
    PageType = List;
    Editable = false;
    SourceTableView = Sorting("Entry No.") where("General Entries Created" = filter(true), Source = filter('LIS'));
