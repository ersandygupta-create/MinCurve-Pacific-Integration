page 50152 "POne Revenue HDR B2C API"
{
    APIGroup = 'apiHIS';
    APIPublisher = 'mindcurve';
    APIVersion = 'v2.0';
    ApplicationArea = All;
    Caption = 'pOneRevenueHDRB2CAPI';
    DelayedInsert = true;
    EntityName = 'pOneRevenueheaderB2C';
    EntitySetName = 'pOnerevenueheadersB2C';
    PageType = API;
    ...
    layout
    {
        area(content)
        {
            ...
            part(RevenueLine; "POne Revenue Line B2C API")
            {
                Caption = 'Lines';
