page 50177 "E3 Purchase Return Indent API"
{
    APIGroup = 'apiHIS';
    APIPublisher = 'mindcurve';
    APIVersion = 'v2.0';
    ApplicationArea = All;
    Caption = 'indentPurchRetDetailAPI';
    DelayedInsert = true;
    EntityName = 'indentPurchRetDetail';
    EntitySetName = 'indentPurchRetDetails';
    PageType = API;
    ...
    layout
    {
        area(content)
        {
            ...
            part(IndentLine; "E3 Purch Ret Indent Line API")
            {
                Caption = 'Lines';
    ...
    begin
        IndentHeader.Setrange("Record Type", Rec."Record Type"::"Purchase Return");
