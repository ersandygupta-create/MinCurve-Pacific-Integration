page 50197 "E3 Purchase Indent Card"
{
    PageType = Card;
    ApplicationArea = All;
    ...
    layout
    {
        area(Content)
        {
            ...
            part(IndentLines; "E3 Pur. Indent Line Subform")
            {
                ApplicationArea = All;
        ...
        area(factboxes)
        {
            part("Attached Documents List"; "Doc. Attachment List Factbox")
            {
                ...
                SubPageLink = "Table ID" = const(Database::"E3 Purchase Indent Header"), "No." = field("Document No.");
            }
