page 50186 "E3 Posted LIS GRN List"
{

    ApplicationArea = All;
    Caption = 'Posted LIS GRN List';
    PageType = List;
    Editable = false;
    CardPageId = 50013;
    DelayedInsert = false;
    ...
    SourceTableView = sorting("Entry No.") where("Record Type" = Filter(GRN), "Document Type" = filter(Order), "Create PO" = filter(true), Source = filter('ITDOSE'));
    UsageCategory = Lists;
