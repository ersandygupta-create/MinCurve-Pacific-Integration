page 50189 "E3 Posted LIS GRN Return List"
{
    ...
    SourceTableView = sorting("Entry No.") where("Record Type" = Filter("GRN Return"), "Document Type" = filter("Return Order"), "Create PO" = filter(true), Source = filter('ITDOSE'));
    UsageCategory = Lists;
