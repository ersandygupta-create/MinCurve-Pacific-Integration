page 50187 "E3 LIS GRN Return List"
{

    ApplicationArea = All;
    Caption = 'LIS GRN Return List';
    PageType = List;
    Editable = false;
    InsertAllowed = false;
    CardPageId = 50024;
    SourceTable = "E3 HIS Purchase Header";
    SourceTableView = sorting("Entry No.") where("Record Type" = Filter("GRN Return"), "Document Type" = filter("Return Order"), "Create PO" = filter(false), Source = filter('ITDOSE'));
    UsageCategory = Lists;
