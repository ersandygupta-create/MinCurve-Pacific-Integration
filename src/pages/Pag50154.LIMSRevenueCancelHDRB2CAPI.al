page 50154 "POne Rev. Cancel HDR B2C API"
{
    APIGroup = 'apiHIS';
    APIPublisher = 'mindcurve';
    APIVersion = 'v2.0';
    ApplicationArea = All;
    Caption = 'pOneRevCancelHDRB2CAPI';
    DelayedInsert = true;
    EntityName = 'pOneRevcancelheaderB2C';
    EntitySetName = 'pOneRevcancelheadersB2C';
    PageType = API;
    ...
    layout
    {
        area(content)
        {
            ...
            part(RevenuecancelLine; "POne Rev. Cancel Line B2C API")
            {
                Caption = 'Lines';
