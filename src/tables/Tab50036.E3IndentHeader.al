table 50036 "E3 Purchase Indent Header"
{
    ...
    fields
    {
        ...
        field(25; Amount; Decimal)
        {
            ...
            CalcFormula = Sum("E3 Purchase Indent Line".Amount WHERE("Document No." = FIELD("Document No.")));
            Editable = false;
        }
    ...
    local procedure DocumentAttachmentNotExist(IndentHeader: Record "E3 Purchase Indent Header"): Boolean
    var
        DocumentAttachment: Record "Document Attachment";
    begin
        DocumentAttachment.SetRange("Table ID", Database::"E3 Purchase Indent Header");
        DocumentAttachment.SetRange("No.", IndentHeader."Document No.");
        exit(DocumentAttachment.IsEmpty());
    end;

    procedure ShortCloseIndent(var IndentHeader: Record "E3 Purchase Indent Header")
    var
        IndentLine: Record "E3 Purchase Indent Line";
