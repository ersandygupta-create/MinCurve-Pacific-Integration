codeunit 50001 "E3 HIS Event Subscriber"
{
    ...
    begin
        Case DocumentAttachment."Table ID" of
            Database::"E3 Purchase Indent Header":
                begin
                    RecRef.Open(Database::"E3 Purchase Indent Header");
    ...
    begin
        if TableNo <> Database::"E3 Purchase Indent Header" then exit;
        FieldNo := 1;
        Result := true;
    end;
    ...
    begin
        If FromRecRef.Number <> Database::"E3 Purchase Indent Header" then exit;
        FromDocumentAttachment.SetRange("Document Flow Purchase");
    end;
    //copy attachments
    Procedure DocAttachFlowFromIndentToPurchase(var Indent: Record "E3 Purchase Indent Header"; var PurchaseHeader: Record "Purchase Header")
    var
