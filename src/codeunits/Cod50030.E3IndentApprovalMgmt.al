codeunit 50030 "E3 Indent Approval Mgmt."
{
    ...
    [IntegrationEvent(false, false)]
    procedure OnCancelIndentApprovalRequest(var E3IndentHeader: Record "E3 Purchase Indent Header") //Cancel Approval Request
    begin
    end;

    [IntegrationEvent(false, false)]
    procedure OnAfterReleaseIndentDoc(var E3IndentHeader: Record "E3 Purchase Indent Header") //Release After Approval
    begin
    end;
    ...
    local procedure RunWorkflowOnCancelIndentApprovalRequest(var E3IndentHeader: Record "E3 Purchase Indent Header")
    var
        WorkflowManagement: Codeunit "Workflow Management";
    begin
    ...
    local procedure RunWorkflowOnAfterReleaseIndentDoc(var E3IndentHeader: Record "E3 Purchase Indent Header")
    var
        WorkflowManagement: Codeunit "Workflow Management";
    begin
    ...
    begin
        WorkflowRequestPageHandling.InsertDynReqPageField(DATABASE::"E3 Purchase Indent Header", E3IndentHeader.FIELDNO("Document No."));
        WorkflowRequestPageHandling.InsertDynReqPageField(DATABASE::"E3 Purchase Indent Header", E3IndentHeader.FIELDNO("Request Date"));
        WorkflowRequestPageHandling.InsertDynReqPageField(DATABASE::"E3 Purchase Indent Header", E3IndentHeader.FIELDNO(Status));
    end;

    local procedure InsertIndentLineReqPageFields()
    var
        IndentLines: Record "E3 Purchase Indent Line";
        WorkflowRequestPageHandling: Codeunit "Workflow Request Page Handling";
    begin
        WorkflowRequestPageHandling.InsertDynReqPageField(DATABASE::"E3 Purchase Indent Line", IndentLines.FIELDNO("Document No."));
        WorkflowRequestPageHandling.InsertDynReqPageField(DATABASE::"E3 Purchase Indent Line", IndentLines.FIELDNO("Line No."));
    end;
    ...
    local procedure IsIndentApprovalsWorkflowEnabled(var E3IndentHeader: Record "E3 Purchase Indent Header"): Boolean
    var
        WorkflowManagement: Codeunit "Workflow Management";
    begin
    ...
    begin
        WorkflowEventhandling.AddEventToLibrary(RunWorkflowOnSendIndentDocForApprovalCode(), DATABASE::"E3 Purchase Indent Header", IndentDocSendForApprovalEventDescTxt, 0, false);
        WorkflowEventhandling.AddEventToLibrary(RunWorkflowOnCancelIndentApprovalRequestCode(), DATABASE::"E3 Purchase Indent Header", IndentDocApprReqCancelledEventDescTxt, 0, false);
        WorkflowEventhandling.AddEventToLibrary(RunWorkflowOnAfterReleaseIndentDocCode(), DATABASE::"E3 Purchase Indent Header", IndentDocReleasedEventDescTxt, 0, false);
    end;
    ...
    var
        WorkflowRequestPageHandling: Codeunit "Workflow Request Page Handling";
    begin
        WorkflowRequestPageHandling.AssignEntityToWorkflowEvent(DATABASE::"E3 Purchase Indent Header", IndentDocumentCodeTxt);
    end;
    ...
    begin
        WorkflowRequestPageHandling.InsertReqPageEntity(IndentDocumentCodeTxt, IndentDocumentDescTxt, DATABASE::"E3 Purchase Indent Header", DATABASE::"E3 Purchase Indent Line");
    end;
    ...
    var
        ...
        WorkflowSetup: Codeunit "Workflow Setup";
    begin
        WorkflowSetup.InsertTableRelation(Database::"E3 Purchase Indent Header", 0, Database::"Approval Entry", ApprovalEntry.FieldNo("Record ID to Approve"));
    end;
    ...
    begin
        case RecRef.Number of
            DATABASE::"E3 Purchase Indent Header":
                begin
                    RecRef.SETTABLE(E3IndentHeader);
    ...
    begin
        ...
        If CommentLine.FindSet() then
            repeat
                ...
                ApprovalCommentLine."Table ID" := Database::"E3 Purchase Indent Header";
    ...
    procedure DeleteReqCommentsToApprovalComments(var E3IndentHeader: Record "E3 Purchase Indent Header")
    var
        ApprovalCommentLine: Record "Approval Comment Line";
    begin
        ApprovalCommentLine.SetRange("Table ID", Database::"E3 Purchase Indent Header");
    ...
    begin
        if ApprovalEntry."Table ID" <> Database::"E3 Purchase Indent Header" then exit;
        IsHandled := true;
    ...
    local procedure EnqueueEmailToSender(E3IndentHeader: Record "E3 Purchase Indent Header"; ApprovalEntry: Record "Approval Entry"): Boolean
    var
    ...
    local procedure EnqueueEmailToSender(E3IndentHeader: Record "E3 Purchase Indent Header")
    var
        ApprovalEntry: Record "Approval Entry";
        UserSetup: Record "User Setup";
        EmailMessage: Codeunit "Email Message";
    ...
    begin
        ...
        ApprovalEntry.SetRange("Table ID", Database::"E3 Purchase Indent Header");
    ...
    local procedure GenerateIndentEmailSubject(E3IndentHeader: Record "E3 Purchase Indent Header"; Status: Enum "Approval Status"): Text
    begin
        Case Status of
            Status::Open:
    ...
    local procedure AddCapexIndentDetails(E3IndentHeader: Record "E3 Purchase Indent Header"; var EmailBody: Text)
    var
